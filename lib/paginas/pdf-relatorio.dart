...
Future<Uint8List> generateResume(PdfPageFormat format, Aula data) async {
  final doc = pw.Document(title: 'My Résumé', author: 'David PHAM-VAN');

  final profileImage = pw.MemoryImage(
    (await rootBundle.load('imagens/icon.png')).buffer.asUint8List(),
  );
...
Future<pw.PageTheme> _myPageTheme(PdfPageFormat format) async {
  final bgShape = await rootBundle.loadString('imagens/resume.svg');
